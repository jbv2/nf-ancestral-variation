input_file="test/data/results/nf-ancestral_variation-intermediate/_pre4_bed2vcf/5_2.5_Data101719_.filtered.liftover.vcf.gz"
output_directory="test/results"

echo -e "======\n Testing NF execution \n======" \
&& rm -rf test/results/ \
&& nextflow run ancestral_variation2.nf \
