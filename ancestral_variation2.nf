...
The Paleogenomics LAB presents...
  ...
  A pipeline to get the ancestral annotations variants. P2
...
//
// 	publishDir "${results_dir}/_pre4_bed2vcf/",mode:"copy"
//
// 	input:
...
//
// 	output:
// 	file "5_2.5_Data101719_.filtered.liftover.vcf.g*" into results_pre4_bed2vcf
//
// 	"""
...
/* get the ancestral genomes into a channel */
  // Channel
	// .fromPath("${params.neandertal}*")
	// .toList()
	// .set{ neandertal_vcf }
	// Channel
	// .fromPath("${params.denisovan}*")
	// .toList()
	// .set{ denisovan_vcf }
	// Channel
	// .fromPath("${params.chimpance}*")
	// .toList()
	// .set{ chimpance_vcf }
